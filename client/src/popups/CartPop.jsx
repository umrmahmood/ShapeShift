	...
	return (
		<div className="custom-popup-overlay">
          ...
          <div className="popup-empty-cart">
            <div> <img src={emptyCart} alt="emptyCart" /></div>
            <div className="empty-cart-message">Your cart is empty</div>
            <p className="popup-empty-cart-para">Check out our <Link className={"empty-cart-para-link"}to="/home" onClick={onClose}>market place</Link></p>
          </div>
				) : (
          <>
          <h3 className="popup-items-in-cart">Items in Cart</h3>
              ...
              <li className="popup-cart-items-list"key={index}>
								...
								<div>{item.price.toFixed(2)} {item.currency}</div>
                <div className="popup-cart-trash"><FontAwesomeIcon
									icon={faTrash}
						...
						<li>
							...
							>
							<FontAwesomeIcon icon={faRightFromBracket} />	View cart and check out
							</Link>
						</li>
					</ul>
          </>
