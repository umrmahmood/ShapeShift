...
const STLViewer = () => {
  ...
  useEffect(() => {
    ...
    loader.load(URL.createObjectURL(stlFile), (geometry) => {
      ...
      const gridTexture = new THREE.TextureLoader().load('path/to/grid_texture.png'); // Replace 'path/to/grid_texture.png' with the path to your grid texture image
    ...
    // scene.add(directionalLight);
      ...
      const material = new THREE.MeshPhongMaterial({ color: 0x2194ce }); // Phong material
  ...
  return (
    <div>
      ...
      <div ref={mount} id="stl-container"></div>
    </div>
  );
};
