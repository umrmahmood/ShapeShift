...
const Resistance = () => {
	...
	const handleResistanceSelection = (color) => {
		setSelectedResistance(color);
	};
		...
		<div className="wrapper-outter">
			<div className="material-intro">
				...
				<div className="selection">
					<div className="slected-swatch"> <h3>{selectedResistance}</h3></div>
				</div>
			</div>

			<div className="popup-button" onClick={togglePopup}>How to choose resistance?</div>
...
<b>The strength of a design is directly related to infill percentage</b>.
